                ...
                <div className="skill_container">
                    <div className="container_top container">
                        ...
                        <div className="skill_row row">
                            <div className="my_skill animat_right col-sm-3">
                                <img src="../img/html.png" />
                                <p className="name_skill">HTML</p>
                            </div>
                            <div className="my_skill animat_down col-sm-3">
                                <img src="../img/css.png" />
                                <p className="name_skill">CSS</p>
                            </div>
                            <div className="my_skill animat_left col-sm-3">
                                <img src="../img/js.png" />
                            ...
                            <div className="my_skill animat_up col-sm-3">
